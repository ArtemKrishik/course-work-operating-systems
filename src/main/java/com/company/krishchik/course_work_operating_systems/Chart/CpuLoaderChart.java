...
public class CpuLoaderChart extends JFrame{
    ...
    public void go() {
        ...
        chart = QuickChart.getChart("загруженность процессора", "время", "загруженность", "randomWalk", new double[]{0}, new double[]{0});
    ...
    private class MySwingWorker extends SwingWorker<Boolean, double[]> {
        ...
        private static double getProcessorLoad() throws InterruptedException {
            Thread.sleep(50);
